<!doctype html>
    <html>
        <head>
            <title>Perpustakaan SMK Widjaya Ngoro</title>
        ...
        <body>
            ...
            <div class="navbar navbar-default">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo site_url('web');?>">Perpustakaan SMK Widjaya Ngoro</a>
                </div>
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#login_anggota" data-toggle="tab">Login Anggota</a>
                                    </li>
                                    <li><a href="#login_admin" data-toggle="tab">Admin Login</a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="login_anggota">
                                        <form class="form-horizontal" role="form" action="<?php echo site_url('web/proses_anggota');?>" method="post">
                                            <?php echo $this->session->flashdata('message');?>
                                            <div class="form-group">
                                                <label for="inputEmail3" class="col-sm-3 control-label">
                                                    NIS</label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="username" class="form-control" id="inputEmail3" placeholder="NIS Anggota" required>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="login_admin">
